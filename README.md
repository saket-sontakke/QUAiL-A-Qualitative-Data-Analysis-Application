...
| **[QUAiL Beta v1.3.0](https://github.com/saket-sontakke/QUAiL-A-Qualitative-Data-Analysis-Application/blob/d8d962e5fa4747af2d851995a87b4fddb10d84e8/QUAiL%20Developer%20Guide%20%5BBeta%20v1.3.0%5D.pdf)** | 15-Dec-25 | - Major Refactoring of monolithic **Hooks.jsx** into specialized domain hooks. <br> - Added **Optimistic UI.** <br> - **Atomic DB Operations:** Replaced full document overwrites with atomic MongoDB updates ($push/$set). | $\color{red}\text{Inactive}$ |
| **[QUAiL Beta v2.0.0](https://github.com/saket-sontakke/QUAiL-A-Qualitative-Data-Analysis-Application/blob/e056ad53f033cec5fd65647b295a1d1f5ac1e619/QUAiL%20Developer%20Guide%20%5BBeta%20v2.0.0%5D.pdf)** | 29-Dec-25 | - Added missing current project's **Coded Segments Export Route**. <br> - Fixed **Multi-tab Desynchronization** problem <br> - Enhanced Edit Mode with **File-Level Tab Locking** and **Intermediate Saves**. <br> - Implemented Automated **Janitor** and **Deep Clean** Scripts for disk cleanup. <br> - Upgraded **Memos** to **Draggable** pop-ups. <br> - Added **Delete Account** feature, **Privacy Policy** page, and **ICCE 2025 Paper** page. <br> - Made home page layout **Responsive**. <br> - Added **Smart Text Selection**. | [Active](https://quail.edarts.online/) |
