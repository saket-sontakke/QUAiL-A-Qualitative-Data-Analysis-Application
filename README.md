...
| #3            | •	Code System (Manual Coding) <br> •	Left Panel (Imported Files, Code Definitions, Code Segments) <br> •	Document Viewer Toolbar (Coder, Highlighter, Eraser, Search bar, Memos) <br> •	Export Code System | •	No memos, visualizations, export functionalities <br> •	Lacks AI enabled features |
| #4            | •	Memos <br> •	Export Code System <br> •	Visualizations | *(To be updated)* |
