            ...
            <div className="absolute md:-top-24 md:left-[-80px] z-30 flex items-center">
             ...
             <div className="flex flex-col -ml-10">
              <motion.span
                ...
                className="el-messiri-bold text-5xl md:text-9xl font-extrabold text-[#132142] dark:text-gray-300 leading-tight"
              >
                QUAiL
              </motion.span>
              <motion.span
                ...
                className="el-messiri-bold text-base md:text-xl font-medium text-gray-500 self-end -mt-1 md:-mt-10"
              >
                Beta v1.0.0
              </motion.span>
            </div>
          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-y-3 px-6 md:flex-row">
            <div className="flex items-center">
              ...
              <div className="flex flex-col -ml-2">
                <span className="el-messiri-bold text-4xl font-extrabold leading-none text-[#132142] dark:text-gray-300">
                  QUAiL
                </span>
                <span className="el-messiri-bold -mt-1 ml-12 text-xs font-medium text-gray-500">
                  Beta v1.0.0
                </span>
              </div>
            </div>
