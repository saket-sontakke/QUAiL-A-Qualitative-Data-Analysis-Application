...
//   return (
//     <div className="min-h-screen bg-gray-100 text-gray-800 transition-colors duration-500">
//       <Navbar />
//       <div className="container mx-auto p-6 pt-20"> {/* Added pt-20 to account for fixed Navbar */}
//         {/* <h1 className="text-4xl font-bold text-center mb-10 text-[#1D3C87]">
//           My Projects
//         </h1> */}
...
//         {projects.length === 0 ? (
//           <p className="text-center text-gray-600 text-lg">No projects found. Create one to get started!</p>
//         ) : (
//           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//             {projects.map((project) => (
//               <motion.div
//                 key={project._id}
//                 className="bg-white rounded-xl shadow-lg p-6 relative flex flex-col justify-between transform transition duration-500 hover:scale-[1.02] hover:shadow-2xl"
//                 initial={{ opacity: 0, y: 20 }}
//                 animate={{ opacity: 1, y: 0 }}
//                 whileHover={{ translateY: -5 }}
//                 transition={{ duration: 0.3 }}
//               >
//                 <div>
//                   <h2 className="text-2xl font-semibold mb-3 text-[#1D3C87]">
//                     {project.name}
//                   </h2>
...
//                 animate={{ scale: 1 }}
//                 exit={{ scale: 0.8 }}
//                 className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-sm text-center"
//               >
