      ...
      <div className={`sticky top-[-18px] z-10 bg-white dark:bg-gray-800 py-4 flex justify-between items-center gap-4 border-b border-gray-200 dark:border-gray-700`}>
        {tableView === 'overlaps' ? (
          ...
          <div className="flex-grow flex items-center gap-4">
            <input type="text" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder="Search by code or text…" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-900 dark:focus:ring-[#F05623] dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" />
