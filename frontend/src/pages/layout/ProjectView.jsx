...
// // Import the new refactored hooks
// import useProjectView from '../hooks/useProjectView.jsx';
...
//   // Use the new refactored hook
//   const {
//     projectName, project, fetchProject, projectId, error, loading, 
//     selectedContent, selectedFileId, selectedFileAudioUrl, 
//     showImportedFiles, setShowImportedFiles, handleFileChange, 
//     handleSelectFile, handleDeleteFile, handleRenameFile, handlePinFile,
//     pinnedFiles, handleExportFile, codeDefinitions, showCodeDefinitions, 
//     setShowCodeDefinitions, showDefineCodeModal, setShowDefineCodeModal, 
//     codeDefinitionToEdit, setCodeDefinitionToEdit, handleSaveCodeDefinition, 
//     handleDefineCodeModalClose, handleDeleteCodeDefinition,
//     handleDefineModalErrorSetter, codedSegments, inlineHighlights, 
//     groupedCodedSegments, expandedCodes, toggleCodeGroup, showCodedSegments, 
//     setShowCodedSegments, showCodedSegmentsTableModal,
//     setShowCodedSegmentsTableModal, activeCodedSegmentId, setActiveCodedSegmentId,
//     handleAssignCode, handleReassignCodeClick, setSegmentToReassign, 
//     handleDeleteCodedSegment, handleExportFileCodedSegments, handleExportOverlaps, 
//     memos, groupedMemos, showMemosPanel, setShowMemosPanel, showMemoModal, 
//     setShowMemoModal, memoToEdit, setMemoToEdit, currentMemoSelectionInfo, 
//     activeMemoId, setActiveMemoId, handleSaveMemo, handleDeleteMemo, 
//     handleExportMemos, viewerRef, viewerSearchQuery, viewerSearchInputRef, 
//     viewerSearchMatches, currentMatchIndex, handleViewerSearchChange,
//     handleClearViewerSearch, goToNextMatch, goToPrevMatch, annotationToScrollToId,
//     setAnnotationToScrollToId, currentSelectionInfo, createRangeFromOffsets,
//     getSelectionInfo, handleViewerMouseUp, showFloatingToolbar, setShowFloatingToolbar,
//     floatingToolbarPosition, handleCodeSelectionAction, handleHighlightSelectionAction,
...
//     floatingAssignCodePosition, setFloatingAssignCodePosition, showFloatingMemoInput,
//     setShowFloatingMemoInput, floatingMemoInputPosition, activeTool, setActiveTool,
//     highlightColors, selectedHighlightColor, setSelectedHighlightColor, 
//     showHighlightColorDropdown, setShowHighlightColorDropdown, showCodeColors, 
//     setShowCodeColors, showCodeDropdown, setShowCodeDropdown, showConfirmModal, 
//     setShowConfirmModal, confirmModalData, setConfirmModalData, searchQuery, 
//     setSearchQuery, searchInputRef, handleMergeCodes, handleSplitCodes, undo, 
//     redo, canUndo, canRedo, handleCreateMemoForSegment, handleCommitNewFile,
//     handleUpdateFileContent, handleTextImport, handleAudioImport,
//     transcriptionStatus
//   } = useProjectView({ onImportSuccess: enterEditMode, setFileInEditMode: setFileInEditMode, isInEditMode: isEditing });
...
//       {transcriptionStatus && transcriptionStatus.isActive && (
//         <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black bg-opacity-70">
//           <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-xl dark:bg-gray-800">
//             <h3 className="mb-4 text-xl font-bold text-[#1D3C87] dark:text-[#F05623]">
//               {transcriptionStatus.message}
